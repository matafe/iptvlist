...
<section class='container'>
          <hgroup>
            <h1>Seja bem-vindo a Aplicação de Lista de IPTV</h1>
          </hgroup>
        ...
        <div class="row">
          <section class='col-xs-12 col-sm-6 col-md-6'>
            <section>
              <h2>O que é esta aplicação?</h2>
                <p>Esta é uma aplição streaming de listas de <a target="_blank" href="https://pt.wikipedia.org/wiki/IPTV">IPTV</a>. </p>
                <p>São vários canais brasileiros, com alta qualidade (High Definition), sem antena, tudo pela internet!!!</p>
                <p>Esta morando no exterior e não quer pagar assinatura de serviços caros? Não perca tempo. Peça seu teste agora!</p>

              <h2>Como funciona?</h2>
                <p>
                  Você receberá um link o qual usará no seus aplicativos de streaming de video. SmartTV, Computador, Iphone/Android, etc...
                </p>

              <h2>Quanto custa?</h2>
                <p>Para você irei fazer um preço de banana! Só porque estou iniciando agora com os testes de serviço. Entre em contato comigo, faça o teste gratuito!</p>
...
<p>After pushing changes, you'll need to manually trigger a build if you did not setup a webhook as described above.</p>
 -->
          ...
          <section class="col-xs-12 col-sm-6 col-md-6">
                ...
                <h2>Como faço a configuração?</h2>
                <br/>
                <!-- 
                  <ul>
                    <li>Na minha Televisão;</li>
                    <li>No meu Computador;</li>
                    <li>No meu Celular;</li>
                  </ul>
 -->
                <h3>SMART TV</h3>
                <p>	Com as SMART TV hoje em dia, é possivel fazer a instalação de aplicativos diretamente da internet para a TV, para as TVs LG e Samsungs, existe o aplicativo SMART IPTV.<a target="_blank" href="tutorial_config_smart_iptv.html"> Clique aqui!</a></p>

                <h3>VLC</h3>
                <p>O <a target="_blank" href="https://www.videolan.org">VLC media player</a> é um aplicativo para assitir filmes e músicas open source muito utilizado e bem simples! Veja como configurar sua lista no VLC. <a target="_blank" href="tutorial_config_vlc.html"> <br>Clique aqui!</a></p>
				
				<h3>Iphone e Android</h3>
				<p>Para Iphone existem alguns aplicativos na AppStore: Ex: GSE IPTV, IPTV M3U, etc...
				Para Android existem alguns aplicativos no Goople Play Store: Ex: IPTV, etc...</p>
				
				
				
                <h2>Quero testar agora!</h2>
                <p>Caso você deseja testar, favor enviar um email para <a href="mailto:matafeiptvapp@gmail.com">matafeiptvapp@gmail.com</a> solicitando um teste grátis. Um link será enviado para você com as instruções de para seu teste.</p>
...
<!-- 
 ...
 -->                  
        ...
        %>
        <footer>
          <div>&copy; <%=year%> IPTV App  : <a href="mailto:matafeiptvapp@gmail.com">matafeiptvapp@gmail.com</a></div>
        </footer>
</section>
</body>
</html>